export function DiagnosticPage() {
  const diagnostics = {
    ...
    environment: {
      ...
      VITE_AZURE_CLIENT_ID: import.meta.env.VITE_AZURE_CLIENT_ID ? 'SET' : 'NOT SET',
      VITE_AZURE_TENANT_ID: import.meta.env.VITE_AZURE_TENANT_ID ? 'SET' : 'NOT SET',
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">🔍 Diagnostic Information</h1>
        
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Environment Status</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Console Logs</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Quick Tests</h2>
